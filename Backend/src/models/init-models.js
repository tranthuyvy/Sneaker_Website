...
function initModels(sequelize) {
  ...
  user.belongsTo(address, { as: "default_address_address", foreignKey: "default_address"});
  address.hasMany(user, { as: "users", foreignKey: "default_address"});
  ...
  discount_product.belongsTo(product, { as: "id_product_product", foreignKey: "id_product"});
  product.hasMany(discount_product, { as: "discount_products", foreignKey: "id_product"});
