...
const ImportWarehouse = () => {
    ...
    return (
        <Box>
            ...
            <div style={{ float: "right", marginTop: "30px", marginRight: "150px", fontSize: "1.2rem" }}>
                <div style={{ display: "flex", width: "300px" }}>
                    <div style={{ flex: 4, fontWeight: "bold" }}>Quantity:</div>
                    <div style={{ flex: 2 }}>{quantity}</div>
                </div>
                <div style={{ display: "flex", width: "300px", marginTop: "20px" }}>
                    <div style={{ flex: 4, fontWeight: "bold" }}>Total:</div>
